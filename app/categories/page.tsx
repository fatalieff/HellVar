...
const getDatabaseCategoriesForCategory = (categoryKey: string): string[] => {
  switch (categoryKey) {
    ...
    case "plumbing": return ["Santexnik"];
    case "cleaning": return ["Təmizlik xidməti", "Təmizlik"];
    case "nanny": return ["Dayə"];
    case "boiler": return ["Kombi Ustası"];
    case "it_tech": return ["İT / Texniki yardım", "Digər"];
    case "repair": return ["Ev təmiri", "Mebel Ustası", "Rəngsaz", "Alçipan Ustası", "Kafel-Metlax Ustası"];
    default: return [];
  }
};
